...
| DA-11 | Перенос auth, sessions и role checks на Appwrite | completed | 10 |
| DA-12 | Перенос write-path и админских операций на Appwrite | completed | 10 |
| DA-13 | Cutover, удаление Supabase legacy, тестирование и финальная документация | completed | 10 |
