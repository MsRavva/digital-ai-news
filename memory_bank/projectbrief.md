...
| DA-02 | Текущая аутентификация и роли на Supabase | completed | 10 |
| DA-03 | Безопасный redirect flow после авторизации и OAuth | completed | 8 |
| DA-04 | CRUD публикаций с Markdown-редактором | completed | 12 |
...
| DA-08 | Appwrite technical blueprint и целевая архитектура миграции | completed | 10 |
| DA-09 | Provider-agnostic service layer для auth и data | completed | 10 |
| DA-10 | Перенос read-path на Appwrite | pending | 8 |
| DA-11 | Перенос auth, sessions и role checks на Appwrite | pending | 10 |
| DA-12 | Перенос write-path и админских операций на Appwrite | pending | 10 |
| DA-13 | Cutover, удаление Supabase legacy, тестирование и финальная документация | pending | 10 |
