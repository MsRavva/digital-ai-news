...
- Выполнен перенос БД и Auth-пользователей из Appwrite Cloud на собственный инстанс (selfhosted) `aw.note-canopus.ts.net/v1`.
- Продакшн-версия на Vercel перенастроена и успешно задеплоена под новый инстанс.
- Исправлен заголовок в Hero секции на «Токены на ветер!».
