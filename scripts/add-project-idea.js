...
// Данные публикации
const postData = {
  title: "Персональный образовательный ассистент на базе ИИ: идеальный проект для начинающих разработчиков",
  content: fs.readFileSync(path.join(__dirname, '../publication-content.md'), 'utf8'),
...
async function createPost(postData) {
  try {
    ...
    if (!userDoc.exists) {
      ...
      console.log(`Создан профиль для пользователя: Василий Смирнов (ID: ${authorId})`);
    }
