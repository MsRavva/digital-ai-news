...
async function fixPostVisibility() {
  try {
    ...
    console.log('- Дата создания:', updatedPostData.created_at ? updatedPostData.created_at.toDate() : null);
    console.log('- Дата обновления:', updatedPostData.updated_at ? updatedPostData.updated_at.toDate() : null);
