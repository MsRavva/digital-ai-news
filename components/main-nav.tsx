...
import { Archive, FileDown, Newspaper } from "lucide-react"
...
export function MainNav() {
  ...
  const canScrape =
    isTeacherOrAdmin || (user && user.uid === "4J9Vf4tqKOU7vDcz99h6nBu0gHx2")
      ...
      <div className="flex items-center">
        ...
        <nav className="hidden md:flex items-center space-x-6">
          ...
          {isTeacherOrAdmin && (
            <Link
              href="/archive"
              className="text-base font-medium transition-all duration-200 hover:text-primary relative after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 hover:after:w-full after:bg-primary after:transition-all after:duration-200 flex items-center gap-1"
            >
