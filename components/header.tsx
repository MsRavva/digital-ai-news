    ...
    return (
        <header>
            <nav
                ...
                className={cn('fixed z-50 w-full border-b transition-colors duration-150', scrolled && 'bg-background/80 backdrop-blur-xl')}>
                <div className="mx-auto w-full lg:w-[60%] px-6 transition-all duration-300">
