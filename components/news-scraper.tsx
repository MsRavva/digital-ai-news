      ...
      toast({
        ...
        description:
          error instanceof Error
            ? error.message
            : "Не удалось извлечь контент. Попробуйте другой URL.",
        variant: "destructive",
      })
    } finally {
      setLoading(false)
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Введите URL новости для импорта и публикации
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="mb-4">
            ...
            <TabsTrigger value="preview" disabled={!scrapedData}>
              Предпросмотр
            </TabsTrigger>
            <TabsTrigger value="edit" disabled={!scrapedData}>
              Редактирование
            </TabsTrigger>
          </TabsList>
