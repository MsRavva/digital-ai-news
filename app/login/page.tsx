      ...
      <div className="saas-window max-w-md w-full">
        ...
        <Card className="border-0 shadow-none dark:bg-[#0e1012] text-white">
          <CardHeader className="space-y-1 pb-2">
            <CardTitle className="text-2xl font-bold text-center text-white">Вход в AI News</CardTitle>
          </CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-xs text-gray-400 hover:text-saas-purple">
                    Забыли пароль?
                  </Link>
                </div>
                <div className="relative">
                  <Input
                    ...
                    required
                    className="border border-gray-600 bg-[#1a1b23] rounded-md h-11 focus:border-saas-purple focus:ring-saas-purple pr-10 text-white"
                  />
                  <button
                    type="button"
